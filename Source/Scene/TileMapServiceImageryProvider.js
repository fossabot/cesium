...
define([
    ...
    var TileMapServiceImageryProvider = function TileMapServiceImageryProvider(options) {
        ...
        function metadataSuccess(xml) {
            ...
            that._minimumLevel = defaultValue(parseInt(tilesetsList[0].getAttribute('order'), 10), that._minimumLevel);
            that._maximumLevel = defaultValue(parseInt(tilesetsList[tilesetsList.length - 1].getAttribute('order'), 10), that._maximumLevel);
